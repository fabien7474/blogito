...
<div>
  <ul id="topnavigation_" class="horizmenu mlhorizmenu">
    ...
    <li class="${controllerName.equals('entry') ? 'current' : ''}">
    <g:link controller="entry" action="index" class="icon icon_page">Entries</g:link>
    <ul class="submenu">
      <li>
      <g:link controller="entry" action="index" class="icon icon_page">List Entries</g:link>
      </li>
      <li>
      <g:link controller="entry" action="create" class="icon icon_page">New Entry</g:link>
      </li>
    </ul>
    </li>
