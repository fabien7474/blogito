...
class EntryController {
    ...
    def save = {
        ...
        if(!entryInstance.hasErrors() && entryInstance.save()) {
            ...
            //Allow the user that created this entry to edit it
            def editPerm = new Permission(type: Permission.wildcardPerm)
            editPerm.target = "blog:entry:*:${entryInstance.id}"
            permissionService.createPermission(editPerm, entryInstance.author)
